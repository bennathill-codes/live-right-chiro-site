...
import { Activity, Check, Clock, Phone, Calendar, ChevronLeft, ShieldCheck, HeartHandshake } from 'lucide-react';
    ...
    <div className="bg-white min-h-screen pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-8">
          ...
          <span>/</span>
          <span className="text-gray-900 font-medium">Upper & Lower Back Pain</span>
        </div>
        ...
        >
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 tracking-tight mb-6 leading-tight">
              Upper & Lower Back Pain Care
            </h1>
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed font-light mb-8">
              Chiropractic care for upper and lower back pain restores proper spinal alignment and nerve function, allowing you to reclaim your mobility and live a pain-free life focused on what matters most to you.
            </p>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start mb-20">
          <div className="lg:col-span-7 space-y-8">
            <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Understanding Back Pain</h2>
            <div className="text-gray-600 text-lg leading-relaxed space-y-6 font-light">
              <p>
                Whether it is a dull ache in your lower back or sharp tension between your shoulder blades, back pain can halt your active lifestyle. Misalignments in the spine (subluxations) put uneven stress on your muscles, ligaments, and nerves, leading to spasms, stiffness, and localized or radiating discomfort.
              </p>
              <p>
                At Live Right Chiropractic, we do not believe in quick cover-ups. Dr. Calvin Smolich conducts a complete biomechanical exam to trace the issue back to its source—whether that is postural strain, spinal instability, muscle imbalances, or ergonomic habits from desk work.
              </p>
            </div>
            ...
            <div className="space-y-6 pt-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  "Complete orthopedic and posture evaluation",
                  "Hands-on joint adjustments to restore motion",
                  "Soft tissue and muscle release therapy",
                  "Postural rehabilitation and ergonomics guidance",
                  "Personalized supplement plans for recovery",
                  "At-home mobility routines to lock in progress"
                ].map((item, i) => (
          ...
          <div className="lg:col-span-5 bg-gray-50 rounded-[2rem] p-8 md:p-10 border border-gray-100 space-y-8">
            ...
            <ul className="space-y-4">
              {[
                { title: "Lower Back Stiffness", desc: "Difficulty bending, twisting, or standing up straight after sitting." },
                { title: "Sharp Shooting Pain", desc: "Sudden pain when lifting, twisting, or making quick movements." },
                { title: "Upper Back & Shoulder Tension", desc: "Chronic tightness across the shoulder blades, often from screen work." },
                { title: "Muscle Spasms & Aches", desc: "Deep throbbing or tight muscle knots that refuse to release." },
                { title: "Disc Issues & Sciatic Pressure", desc: "Nerve compression leading to weakness or radiating discomfort." }
              ].map((symptom, i) => (
