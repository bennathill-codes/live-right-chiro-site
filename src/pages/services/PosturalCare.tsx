    ...
    <div className="bg-white min-h-screen pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-8">
          ...
          <span>/</span>
          <span className="text-gray-900 font-medium">Postural Care</span>
        </div>
        ...
        >
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed font-light mb-8">
              Personalized postural correction identifies and fixes the underlying spinal misalignments caused by daily habits, transforming your stance to eliminate chronic strain and naturally boosting your energy.
            </p>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start mb-20">
          <div className="lg:col-span-7 space-y-8">
            <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Understanding Postural Strain</h2>
            <div className="text-gray-600 text-lg leading-relaxed space-y-6 font-light">
              <p>
                In today's digital age, we spend hours looking at screens, hunched over desks, or slouched in cars. Over time, these repetitive positions reshape our posture, forcing our spine out of its natural alignment. This creates constant, low-grade mechanical stress on the surrounding muscles, ligaments, and nerves.
              </p>
              <p>
                Common issues like "text neck" (where the head is jutted forward) can add up to 30 additional pounds of pressure on your neck and upper back. This muscular imbalance leads to chronic stiffness, tension headaches, shallow breathing, and decreased overall energy as your body works twice as hard just to keep you upright.
              </p>
              <p>
                At Live Right Chiropractic, Dr. Calvin Smolich provides detailed posture assessments to identify specific areas of structural and muscle imbalance. Through gentle, corrective spinal adjustments and custom supportive exercises, we help you restore a neutral, upright stance that naturally reduces stress and allows you to move with ease.
              </p>
            </div>

            <div className="space-y-6 pt-4">
              <h3 className="text-2xl font-bold text-gray-900">Our Postural Care Approach</h3>
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  "Detailed static and dynamic posture analysis",
                  "Targeted joint adjustments to restore range of motion",
                  "Myofascial release for tight chest and neck muscles",
                  "Strengthening exercises for weak upper back stabilizers",
                  "Ergonomic workspace assessment and advice",
                  "Daily micro-stretches to combat desk strain"
                ].map((item, i) => (
          ...
          <div className="lg:col-span-5 bg-gray-50 rounded-[2rem] p-8 md:p-10 border border-gray-100 space-y-8">
            <h3 className="text-2xl font-bold text-gray-900 tracking-tight flex items-center gap-2">
              ...
              <span>Postural Warning Signs</span>
            </h3>
            <ul className="space-y-4">
              {[
                { title: "Forward Head Posture", desc: "The head juts forward from the shoulders, straining the cervical spine and neck muscles." },
                { title: "Rounded Shoulders & Hunching", desc: "Tight pectoral muscles and weak scapular retractors cause the upper back to curve." },
                { title: "Chronic Mid-Back & Neck Tightness", desc: "A constant, dull ache between the shoulder blades that resists massage." },
                { title: "Tension Headaches", desc: "Muscle strain at the base of the skull radiating pain forward to the temples." },
                { title: "Reduced Energy & Fatigue", desc: "The body expends excessive energy trying to support a misaligned structural frame." }
              ].map((symptom, i) => (
