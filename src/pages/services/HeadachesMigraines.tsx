    ...
    <div className="bg-white min-h-screen pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-8">
          ...
          <span>/</span>
          <span className="text-gray-900 font-medium">Headaches & Migraines</span>
        </div>
        ...
        >
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed font-light mb-8">
              Targeted adjustments help reduce the frequency and intensity of headaches and migraines by addressing cervical tension and nerve irritation in the upper spine.
            </p>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start mb-20">
          <div className="lg:col-span-7 space-y-8">
            <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Finding the Root Cause of Head Pain</h2>
            <div className="text-gray-600 text-lg leading-relaxed space-y-6 font-light">
              <p>
                Headaches and migraines are more than just a nuisance—they can disrupt your daily routine, impact your focus, and lower your quality of life. While many people turn to over-the-counter pain medications for temporary relief, these do not address the underlying causes of head pain.
              </p>
              <p>
                Many headaches and migraines are actually linked to tension and misalignments in the neck (cervical spine). When the vertebrae in your upper neck are misaligned, they can irritate nerves, restrict blood flow, and cause surrounding muscles at the base of the skull to tighten. This structural stress can trigger or worsen headaches.
              </p>
              <p>
                Chiropractic care offers a natural, drug-free approach to headache and migraine relief. By performing precise adjustments to the upper cervical spine, Dr. Calvin Smolich helps restore proper spinal alignment, reduce nerve pressure, and alleviate chronic muscle tension. We also look at lifestyle triggers, posture, and wellness habits to help prevent headaches before they start.
              </p>
            </div>

            <div className="space-y-6 pt-4">
              <h3 className="text-2xl font-bold text-gray-900">Our Headache Relief Protocol</h3>
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  "Detailed assessment of the cervical spine",
                  "Precise adjustments to align the upper neck",
                  "Myofascial release for tight suboccipital muscles",
                  "Postural analysis and desk ergonomic guidance",
                  "Identification of lifestyle and nutritional triggers",
          ...
          <div className="lg:col-span-5 bg-gray-50 rounded-[2rem] p-8 md:p-10 border border-gray-100 space-y-8">
            <h3 className="text-2xl font-bold text-gray-900 tracking-tight flex items-center gap-2">
              ...
              <span>Headache Types We Address</span>
            </h3>
            <ul className="space-y-4">
              {[
                { title: "Tension Headaches", desc: "A dull, aching pain often described as a tight band around the forehead or back of the head." },
                { title: "Migraines", desc: "Severe throbbing head pain, usually on one side, often accompanied by nausea and light/sound sensitivity." },
                { title: "Cervicogenic Headaches", desc: "Headaches that originate from issues in the neck joints and muscles, radiating up to the head." },
                { title: "Suboccipital Tension", desc: "Stiffness and pain at the base of the skull where the neck meets the head." },
                { title: "Postural Headaches", desc: "Headaches triggered by prolonged sitting, computer work, or forward head posture." }
              ].map((symptom, i) => (
        ...
        >
          ...
          <div className="relative z-10 max-w-2xl text-center md:text-left">
            <h3 className="text-3xl md:text-4xl font-bold mb-4 tracking-tight">Ready to Live Without Head Pain?</h3>
